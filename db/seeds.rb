...
# Article.create({title: "Air Plane Ride", content: "high in the sky", city: "The Moon", user_id: 1, city_id: 1}, without_protection: true)
# Article.create({title: "Golden Gate", content: "high in the sky", city: "The Moon", user_id: 1, city_id: 1}, without_protection: true)
# Article.create({title: "Bay Bridge", content: "high in the sky", city: "The Moon", user_id: 1, city_id: 1}, without_protection: true)
